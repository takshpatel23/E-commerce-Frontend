...
import { MoveRight } from "lucide-react"; // Using lucide for a cleaner arrow

const Footer = () => {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="bg-slate-950 text-white pt-20 pb-10 px-6 border-t border-slate-900">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5 space-y-8">
            ...
            {/* Newsletter Input - Essential for Classic Design */}
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <ul className="space-y-3 text-slate-400 text-[13px] font-bold uppercase tracking-widest">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="pt-4">
              <p className="text-slate-500 text-[10px] uppercase tracking-widest font-black">Headquarters</p>
              <p className="text-slate-300 text-sm mt-1">123 Fashion Ave, NY 10001</p>
              <p className="text-slate-300 text-sm underline underline-offset-4 decoration-amber-500/30 mt-2 font-bold">
...
// Reusable Monochromatic Social Icon
