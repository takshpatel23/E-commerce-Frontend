      ...
      <main className="pt-32 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-20 space-y-4">
            ...
            <h1 className="text-6xl md:text-7xl font-black text-slate-950 tracking-tighter">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-slate-100 border border-slate-100 rounded-[3rem] overflow-hidden">
            ...
            <div className="bg-white p-12 md:p-16 flex flex-col justify-between">
              <div>
                ...
                <h2 className="text-3xl font-black text-slate-950 tracking-tight mb-4 uppercase">
                  Direct Assistance
                </h2>
                <div className="space-y-4">
                  <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-amber-500 group-hover:text-white transition-all">
                      <Mail size={16} />
                    </div>
                    <span className="text-sm font-bold text-slate-600">concierge@fashionstore.com</span>
                  </div>
                  <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-amber-500 group-hover:text-white transition-all">
                      <PhoneCall size={16} />
                    </div>
                    <span className="text-sm font-bold text-slate-600">+91 12345 67890</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 flex items-center gap-2 text-slate-400">
                <Clock size={14} />
                <span className="text-[10px] font-black uppercase tracking-widest">Available 09:00 — 18:00 IST</span>
              </div>
            </div>
...
const ServiceCard = ({ icon, title, desc, details }) => (
  <div className="bg-white p-12 md:p-16 flex flex-col group hover:bg-slate-50 transition-colors duration-500">
    <div className="text-amber-600 mb-8 transition-transform duration-500 group-hover:-translate-y-2">
      {icon}
    </div>
    <h2 className="text-3xl font-black text-slate-950 tracking-tight mb-4 uppercase">
      {title}
