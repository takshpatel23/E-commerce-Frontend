...
const AddProduct = () => {
  ...
  // 1. Fetch Categories (Nested Structure)
  useEffect(() => {
        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <button type="button" onClick={addImageField} className="flex items-center gap-2 text-amber-600 font-bold text-[10px] uppercase tracking-tighter hover:text-amber-700 transition-colors">
            ...
            <div className="space-y-3">
              ...
              {formData.sizes.map((s, index) => (
                <div key={index} className="flex gap-3 mt-2">
                  ...
                  <input
                    ...
                    className="w-24 p-3 bg-slate-50 rounded-xl border-none focus:ring-2 focus:ring-amber-500 text-sm"
                    required
                  />
              ...
              <button type="button" onClick={addSize} className="flex items-center gap-2 text-amber-600 font-bold text-[10px] uppercase tracking-tighter hover:text-amber-700 transition-colors">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-slate-900 text-white rounded-[1.5rem] font-bold hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 disabled:opacity-50 mt-4"
            >
          ...
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden sticky top-8">
            ...
            <div className="p-6 space-y-3">
              <div className="flex justify-between items-start">
                <h3 className="font-black text-xl text-slate-900 truncate pr-2">
